    ...
    function _createGeneDiagram(gene, geneGroup, options = null) {
        ...
        beHelper
            ...
            .then((data) => {
                ...
                let x = d3.scaleLinear().domain([startUpdated, endUpdated]).range([0, geneWidth]);
                ...
                transcript
                    .selectAll(".transcript rect.utr, .transcript rect.cds, .transcript rect.exon")
                    .data(function (d) {
                        return d["features"].filter(
                            function (d) {
                    ...
                    .attr("width", function (d) {
                        return Math.max(0.5, Math.round(x(d.end) - x(d.start)));
                    })
                    .attr("y", function (d) {
